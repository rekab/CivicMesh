...
// Pixel size: 16. Glyph range: 0x20-0x7E. yAdvance: 16.

#pragma once

#include "gfxfont.h"

const uint8_t LessPerfectDOSVGABitmaps[] PROGMEM = {
...
const GFXglyph LessPerfectDOSVGAGlyphs[] PROGMEM = {
  {     0,   1,   1,   8,    0,    0 },  // 0x20 ' '
  {     1,   4,  10,   8,    2,   -9 },  // 0x21 '!'
  {     6,   6,   4,   8,    1,  -10 },  // 0x22 '"'
  {     9,   7,   9,   8,    0,   -8 },  // 0x23 '#'
  ...
  {   624,   7,   7,   8,    0,   -6 },  // 0x76 'v'
  {   631,   7,   7,   8,    0,   -6 },  // 0x77 'w'
  {   638,   7,   7,   8,    0,   -6 },  // 0x78 'x'
  {   645,   7,  10,   8,    0,   -6 },  // 0x79 'y'
  {   654,   7,   7,   8,    0,   -6 },  // 0x7A 'z'
  {   661,   6,  10,   8,    1,   -9 },  // 0x7B '{'
  {   669,   2,  10,   8,    3,   -9 },  // 0x7C '|'
  {   672,   6,  10,   8,    1,   -9 },  // 0x7D '}'
  {   680,   7,   2,   8,    0,  -10 }  // 0x7E '~'
...
const GFXfont LessPerfectDOSVGA PROGMEM = {
  (uint8_t *)LessPerfectDOSVGABitmaps,
  (GFXglyph *)LessPerfectDOSVGAGlyphs,
  0x20, 0x7E, 16
};
